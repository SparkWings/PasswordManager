...
public class Walkthrough extends JFrame {
	...
	frame.setTitle("Password Manager  - Setup");
	...
	if (option == 0) {
	    ...
	    passwordField.setBounds(210, 90, 180, 20);
	    ...
	    passwordField_1.setBounds(210, 115, 180, 20);
	...
	if (password1.equals(password2)) {
	    try {
		new PasswordAuth().createPasswordStoreFile(password1);
	    } catch (Exception ex) {
